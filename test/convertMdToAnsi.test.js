...
describe('convertMarkdownToAnsi', () => {
  test('valid md to ANSI', () => {
    ...
    const expected = '\x1b[1mЖовта сова\x1b[0m \x1b[3mна\x1b[0m \x1b[7mстарому дереві\x1b[0m відправилася на подорож\x1b[7m\nПід час **своєї_мандрівки**\n\x1b[0mвона зустріла \x1b[3mмаленького\x1b[0m їжачка.';
